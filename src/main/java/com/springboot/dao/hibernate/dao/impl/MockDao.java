package com.springboot.dao.hibernate.dao.impl;
...
import com.springboot.dao.hibernate.entity.AMockEntity;
import com.springboot.dao.hibernate.entity.IMockEntity;
import com.springboot.dao.hibernate.entity.MapToArrayParams;
...
public class MockDao<T extends IMockEntity> implements IMockDao<T> {
	...
	public List<T> getEntities(final Class<T> clazz,
		...
		MapToArrayParams mapToArrayParams = new MapToArrayParams(params, hql, values1, values2, subHql).invoke();
		values1 = mapToArrayParams.getValues1();
		values2 = mapToArrayParams.getValues2();
		subHql = mapToArrayParams.getSubHql();
		if (subHql != null) {
