package com.springboot.dao.hibernate.entity;
...
public class MapToArrayParams {
    ...
    public MapToArrayParams(Map<String, Object> params, StringBuffer hql, Map<String, Object> values1, List<Object> values2, StringBuffer subHql) {
        this.params = params;
        this.hql = hql;
    ...
    public MapToArrayParams invoke() {
